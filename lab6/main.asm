...
My_output_string proc
    ...
    jmp dword ptr CS:[Int_21h_vect] ; переходим на ориг21h 
    ...
    Int_21h_vect dd ? ;dd - 4 byte
    My_string db 'This is the example of 6  lab.$'
My_output_string endp

Init:
    mov AH, 35h
    mov AL, 21h
    int 21h  ; В es:bx адрес прерывания 21
